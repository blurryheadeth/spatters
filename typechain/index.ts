...
export type { Spatters } from "./contracts/Spatters";
export { Spatters__factory } from "./factories/contracts/Spatters__factory";
export type { ISpatters } from "./contracts/SpattersGenerator.sol/ISpatters";
export { ISpatters__factory } from "./factories/contracts/SpattersGenerator.sol/ISpatters__factory";
export type { SpattersGenerator } from "./contracts/SpattersGenerator.sol/SpattersGenerator";
export { SpattersGenerator__factory } from "./factories/contracts/SpattersGenerator.sol/SpattersGenerator__factory";
